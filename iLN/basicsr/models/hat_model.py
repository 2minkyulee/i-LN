...
class HATModel(SRModel):
    ...
    def model_ema(self, decay=0.999):
        ...
        # # Update buffers
        # net_g_buffers = dict(net_g.named_buffers())
        # net_g_ema_buffers = dict(self.net_g_ema.named_buffers())
        #
        # for k in net_g_buffers.keys():
        #     if not "position" in k:
        #         net_g_ema_buffers[k].data.mul_(decay).add_(net_g_buffers[k].data, alpha=1 - decay)
